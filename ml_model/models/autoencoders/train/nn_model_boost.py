...
df_new=df_new[["rpm", "fuel_rate", "turbo_speed", "exhaust_pressure", "boost_pressure"]]
X=df_new.values
sc=StandardScaler()
...
jb.dump(
    ...
    os.path.join(SAVE_DIR, "nn_model_preprocessing_boost.pkl")
)

autoencoder.save(
    os.path.join(SAVE_DIR, "nn_model_boost.keras")
)
