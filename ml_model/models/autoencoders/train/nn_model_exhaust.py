...
df_new=df_new[["rpm", "fuel_rate", "MAF", "turbo_speed", "DPF_delta", "exhaust_pressure"]]
...
output_layer=Dense(units=6,activation="linear")(layer_5)
...
jb.dump(
    ...
    os.path.join(SAVE_DIR, "nn_model_preprocessing_exhaust.pkl")
)

autoencoder.save(
    os.path.join(SAVE_DIR, "nn_model_exhaust.keras")
)
...
leak_X = leak_df[["rpm", "fuel_rate", "MAF", "turbo_speed", "DPF_delta", "exhaust_pressure"]].values
