"""
Django settings for diesel_engine_predictor project.
...
WSGI_APPLICATION = 'diesel_engine_predictor.wsgi.application'

ASGI_APPLICATION = "diesel_engine_predictor.asgi.application"
